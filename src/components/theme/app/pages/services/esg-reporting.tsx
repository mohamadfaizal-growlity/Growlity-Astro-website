      ...
      <section className="bg-gradient-to-br from-[#0066FF] to-[#00C853] text-white py-10">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">ESG & Sustainability Reporting</h1>
            <p className="text-xl text-white/90 mb-8">
              Comprehensive ESG disclosure and reporting aligned with GRI, ISSB, SASB, TCFD, and CSRD
            </p>
            <a href="/contact">
